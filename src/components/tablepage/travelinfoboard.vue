<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="id" label="人员ID" width="150" align="center" sortable>
            </el-table-column>
            ...
            <el-table-column prop="birthYear" label="出生年月" width="150" align="center" sortable>
            </el-table-column>

            <el-table-column prop="totalMile" label="总旅行里程" align="center" width="100">
            </el-table-column>

            <el-table-column prop="totalTime" label="总旅行时间" align="center" width="100">
            </el-table-column>
        ...
        <el-pagination background layout="total,sizes,prev, pager, next,jumper" :current-page="pageInfo.currentPage" :page-size="pageInfo.pageSize" :total="pageInfo.pageTotal" :page-sizes="[10, 20]" @size-change="handleSizeChange" @current-change="handleCurrentChange">
        </el-pagination>
        <!-- 表格---end -->

        <!-- 编辑弹框---start -->
        <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="800px" @close="closeDialog('formEdit')">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                 <el-form-item label="人员ID" prop="id">
                    <el-input v-model="formEdit.id" placeholder="人员ID"></el-input>
                </el-form-item>
                 <el-form-item label="性别" prop="gender">
                ...
                <el-form-item label="总旅行里程" prop="totalMile">
                    <el-input v-model="formEdit.totalMile" placeholder="totalMile"></el-input>
                </el-form-item>
                <el-form-item label="总旅行时间" prop="totalTime">
                    <el-input v-model="formEdit.totalTime" placeholder="totalTime"></el-input>
                </el-form-item>
            </el-form>
